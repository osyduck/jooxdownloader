...
if(!$_POST['q']||!$_POST['w']||!$_POST['r']):
	...
	$ch = curl_init('https://api.joox.com/web-fcgi-bin//web_category_search?callback=mutiara&lang=id&country=id&type=2&search_input='.rawurlencode(trim($_POST['q'])).'&pn='.trim($_POST['w']).'&sin='.trim($_POST['e']).'&ein='.trim($_POST['r']).'&_='.time());
